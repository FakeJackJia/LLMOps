...
class HitReq(FlaskForm):
    ...
    score = FloatField("score", validators=[
        NumberRange(min=0, max=0.99, message="最小匹配度在0-0.99")
    ])
...
class GetDatasetResp(Schema):
    ...
    document_count = fields.String(dump_default=0)
    hit_count = fields.String(dump_default=0)
